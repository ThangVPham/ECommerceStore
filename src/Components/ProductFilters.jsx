            ...
            <button
              ...
              onClick={() => {
                setFilterOptions((oldOptions) => {
                  const price = oldOptions.price.map((item) => {
                    return { ...item, checked: false };
                  });
                  const color = oldOptions.color.map((item) => {
                    return { ...item, checked: false };
                  });
                  return { ...oldOptions, price, color };
                });
              }}
            >
              Clear all
                ...
                {filterOptions.price.map((option, optionIdx) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        setFilterOptions((oldOptions) => {
                          oldOptions.price[optionIdx].checked =
                            e.target.checked;
                          return { ...oldOptions };
                        });
                      }}
                ...
                {filterOptions.color.map((option, optionIdx) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        setFilterOptions((oldOptions) => {
                          oldOptions.color[optionIdx].checked =
                            e.target.checked;
                          return { ...oldOptions };
                        });
                      }}
